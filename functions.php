...
function my_first_customise_option($wp_customize) {
  ...
  $wp_customize->add_setting("card_color_picker", array(
    "default" => ""
  ));
  ...
  $wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'color_picker', array(
    ...
    // control for card color picker
    $wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'card_color_picker', array(
        'label' => 'Card Body Color',
        'section' => 'tims_section',
        'settings' => 'card_color_picker'
      )));
...
function generate_special_css() {
  ...
  $card_body_color = get_theme_mod('card_color_picker');
  ?>
    <style type="text/css">
      .card-title a {
      ...
      .card-body {
        background-color:<?php echo $card_body_color; ?>;
      }
